...
export default function AdminLoginPage() {
  ...
  return (
    ...
    >
      {/* Subtle radial glows — mirrors the public site hero */}
      <div
        aria-hidden="true"
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="group relative mt-1 w-full overflow-hidden rounded-xl py-3 text-sm font-bold text-white transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg disabled:opacity-60 disabled:translate-y-0"
              style={{
