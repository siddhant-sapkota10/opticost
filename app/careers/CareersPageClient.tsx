        ...
        <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          <div className="max-w-3xl">
            ...
            >
              ...
              Join OptiCost Consulting and contribute to practical, trusted, and
              governance-aligned outcomes.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <div className="mb-12">
            ...
            <p
              ...
              style={{ color: C.mutedText }}
            >
              We value consultants who combine technical depth with practical
              judgement, clear communication, and a strong sense of ownership.
              At OptiCost, you will work closely with experienced leaders on
              real client problems spanning cost modelling, financial control,
              governance, and program performance across the public sector.
            </p>
          </div>
          ...
          {!loading && !error && jobs.length === 0 && (
            <div
              className="rounded-[26px] border border-dashed px-6 py-12 text-center sm:px-8 sm:py-16"
    ...
    >
      <div className="p-5 sm:p-7">
        ...
        <button
          ...
          className="inline-flex w-full items-center justify-center gap-2 rounded-xl px-5 py-3 text-sm font-bold text-white shadow-sm transition-transform duration-300 hover:-translate-y-0.5 sm:w-auto"
          style={{ backgroundColor: C.brightGreen }}
        >
            ...
            <form onSubmit={handleSubmit} noValidate className="space-y-5">
              ...
              <AppField label="Resume" name="resume">
                <input
                  ...
                  onChange={handleFile}
                  className="block w-full text-sm file:mr-4 file:cursor-pointer file:rounded-xl file:border-0 file:px-4 file:py-2.5 file:text-sm file:font-bold file:text-white"
  ...
  return (
    <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-2">
      {[1, 2].map((n) => (
        <div
          key={n}
          className="animate-pulse rounded-[26px] border bg-white p-5 shadow-sm sm:p-7"
          style={{ borderColor: "rgba(10,22,40,0.07)" }}
        >
          <div
