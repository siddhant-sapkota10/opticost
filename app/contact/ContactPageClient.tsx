          ...
          <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
            <div>
              ...
              <p
                ...
                style={{ color: C.mutedText }}
              >
                We support organisations that need stronger cost visibility,
                disciplined financial reporting, and practical guidance for
                complex delivery environments. Whether you are shaping a business
                case, strengthening governance, or improving forecasts, our team
