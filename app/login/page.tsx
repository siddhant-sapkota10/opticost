    ...
    >
      ...
      <div className="relative z-10 w-full max-w-[420px]">
        ...
        <p className="mt-6 text-center text-xs" style={{ color: "rgba(255,255,255,0.22)" }}>
          OptiCost Consulting &mdash; Secure Portal
        </p>
      </div>
    </div>
  );
...
function SubmitButton({
  ...
  return (
    <button
      type="submit"
      disabled={loading}
      className="mt-1 w-full overflow-hidden rounded-xl py-3 text-sm font-bold text-white transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg disabled:opacity-60 disabled:translate-y-0"
      style={{
