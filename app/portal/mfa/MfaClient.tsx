...
export default function MfaClient() {
  ...
  return (
    <div className="mx-auto max-w-3xl">
      <div className="rounded-3xl px-8 py-8" style={cardStyle}>
        <div className="mb-7">
          <h1 className="text-2xl font-bold tracking-tight" style={{ color: "#0A1628" }}>
            Secure your portal account
          </h1>
          <p className="mt-1.5 text-sm" style={{ color: "rgba(10,22,40,0.55)" }}>
            Multi-factor authentication is now required before you can view your applications.
          </p>
        </div>

        {loading && (
          <p className="text-sm" style={{ color: "rgba(10,22,40,0.65)" }}>
        ...
        {!loading && mode === "setup" && (
          <div className="space-y-5">
            {!enrollment ? (
              <>
                <p className="text-sm leading-relaxed" style={{ color: "rgba(10,22,40,0.68)" }}>
              ...
              <form onSubmit={verifyEnrollment} className="space-y-5">
                <div className="grid gap-5 md:grid-cols-[220px_1fr]">
                  <div className="rounded-2xl border bg-white p-4" style={{ borderColor: "rgba(10,22,40,0.08)" }}>
                    <img
                      src={qrCodeSrc}
                      alt={enrollment.uri}
                  ...
                  <div className="space-y-4">
                    <div>
                      <p className="text-xs font-semibold uppercase tracking-widest" style={{ color: "rgba(10,22,40,0.45)" }}>
                        Manual setup code
                      </p>
                      <code
                    ...
                    <div className="text-sm leading-relaxed" style={{ color: "rgba(10,22,40,0.65)" }}>
        ...
        {!loading && mode === "challenge" && (
          <form onSubmit={verifyChallenge} className="space-y-5">
            <p className="text-sm leading-relaxed" style={{ color: "rgba(10,22,40,0.68)" }}>
              Enter the current 6-digit code from your authenticator app to continue into your portal.
            </p>
